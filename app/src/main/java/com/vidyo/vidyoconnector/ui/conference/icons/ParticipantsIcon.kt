...
import dev.matrix.compose_routes.navigateToParticipantsScreen

@Composable
fun ParticipantsIcon(modifier: Modifier = Modifier) {
    val navController = LocalNavController.current

    IconButton(
        onClick = { navController.navigateToParticipantsScreen() },
        modifier = modifier,
    ) {
        Image(
